...
const exportedMethods = {
  ...
  async addPost(title, body, tags, posterId) {
    ...
    const animalThatPosted = await animals.getId(posterId);
    ...
    await animals.addPostToAnimal(posterId, newId, title);
  ...
  async removePost(id) {
    ...
    await animals.remove(post.poster.id, id);
    return true;
  },
